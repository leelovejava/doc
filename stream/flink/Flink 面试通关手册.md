...
![组件栈](https://images.gitbook.cn/fa395ba0-1588-11ea-b6bd-13d6a71f4260) 图片来源于：https://flink.apache.org
...
![运行流程图](https://images.gitbook.cn/05a76220-1589-11ea-8029-776dd26574d8) 
...
![集群角色](https://images.gitbook.cn/0ee80150-1589-11ea-81aa-87235fe28d99) 
...
![Slot](https://images.gitbook.cn/17e555f0-1589-11ea-a572-8bd4a271a05d) 在 Flink 架构角色中我们提到，TaskManager 是实际负责执行计算的 Worker，TaskManager 是一个 JVM 进程，并会以独立的线程来执行一个 task 或多个 subtask。为了控制一个 TaskManager 能接受多少个 task，Flink 提出了 Task Slot 的概念。
...
![Flink 分区策略](https://images.gitbook.cn/26f82180-1589-11ea-a0ce-2dfc1182f300)
...
![Slot](https://images.gitbook.cn/38c09730-1589-11ea-81aa-87235fe28d99)
...
![taskManager](https://images.gitbook.cn/3e436b10-1589-11ea-a0ce-2dfc1182f300)
...
![Flink 中的窗口](https://images.gitbook.cn/4dd48e60-1589-11ea-b6bd-13d6a71f4260)
...
![Flink SQL](https://images.gitbook.cn/67b8d250-1589-11ea-8833-c12ffd837eb2)
...
![Flink流](https://images.gitbook.cn/6f6f7620-1589-11ea-81aa-87235fe28d99)
...
Flink 的分布式快照是根据 Chandy-Lamport 算法量身定做的。简单来说就是持续创建分布式数据流及其状态的一致快照。
 ...
 ![Flink 分布式快照](https://images.gitbook.cn/792b38c0-1589-11ea-9a65-47da06f19b9d)
...
![Flink 中的分布式快照机制](https://images.gitbook.cn/b8652280-1589-11ea-8029-776dd26574d8)
