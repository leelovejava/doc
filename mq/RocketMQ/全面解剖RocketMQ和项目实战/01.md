...
![消息队列](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224620-479305.png)
...
![解耦](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224624-522700.png)

使用消息队列解耦合，系统的耦合性就会提高了。比如物流系统发生故障，需要几分钟才能来修复，在这段时间内，物流系统要处理的数据被缓存到消息队列中，用户的下单操作正常完成。当物流系统回复后，补充处理存在消息队列中的订单消息即可，终端系统感知不到物流系统发生过几分钟故障。

![解耦](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224626-56989.png)

* 流量削峰

![流量削峰](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224627-975011.png)

应用系统如果遇到系统请求流量的瞬间猛增，有可能会将系统压垮。有了消息队列可以将大量请求缓存起来，分散到很长一段时间处理，这样可以大大提到系统的稳定性和用户体验。

![系统流量削峰](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224629-614846.png)
...
![数据分发](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224630-322281.png)

通过消息队列可以让数据在多个系统更加之间进行流通。数据的产生方不需要关心谁来使用数据，只需要将数据发送到消息队列，数据使用方直接在消息队列中直接获取数据即可

![数据分发](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224631-850918.png)
...
![RocketMQ角色](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224637-606193.jpeg)
...
![RocketMQ集群](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224700-388650.png)
...
![jps](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/225048-81213.png)
...
![rocketmq-console](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224745-782939.png)
...
![rocketmq-console2](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224803-105667.png)

集群状态：

![rocketmq-console3](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224818-167835.png)
...
![事务信息](http://th2.oss-accelerate.aliyuncs.com/th2/202005/21/224835-882872.png)



上图说明了事务消息的大致方案，其中分为两个流程：正常事务消息的发送及提交、事务消息的补偿流程。

> Half半消息,消费者不可见,成功commit后才可见,异常回滚删除
