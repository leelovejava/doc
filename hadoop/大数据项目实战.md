...
修改JAVA_HOME
export HBASE_MANAGES_ZK=false12
...
// 6 查看表数据
scan 'course_clickcount'12345678910111213
```
5）代码地址
...
if __name__ == '__main__':
    ...
    while True:
        generate_log()
        time.sleep(60)12345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455565758596061626364656667
```
...
-Dflume.root.logger=INFO,console12345
```
5）运行日志生成器
python3 generate_log.py1
